...
public class CommandsInventory extends VariablesManager
{
    public static Inventory commandsInventory(Player p)
    {
        ...
        BItemStack filler = new BItemStack(Material.STAINED_GLASS_PANE, 1).setDisplaName("");
        filler.getItem().setDurability(DyeColor.WHITE.getData());
        ...
        return bInventory.getInventory();
    }
}
